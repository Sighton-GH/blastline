...
export const BOSS_ENGAGEMENT_Y = 0.22; // bosses must be fully visible below the HUD before they can take damage
...
export const SHOP_CATALOG = Object.freeze([
  { id: 'reinforcements', title: 'Squad', short: '+8 squad', baseCost: 240, maxTier: 99, tone: 'cyan', asset: 'assets/blastline/ui/upgrade-troops.webp', synergy: 'More rifles on the line' },
  { id: 'damage', title: 'Damage', short: '+1 power', baseCost: 320, maxTier: 98, tone: 'gold', asset: 'assets/blastline/ui/upgrade-power.webp', synergy: 'Breaks armored targets' },
  { id: 'fireRate', title: 'Fire Rate', short: '+0.4 cadence', baseCost: 300, maxTier: 9, tone: 'green', asset: 'assets/blastline/ui/upgrade-rate.webp', synergy: 'Builds pressure faster' },
  { id: 'multishot', title: 'Multishot', short: '+1 round, softer hits', baseCost: 720, maxTier: 5, tone: 'purple', asset: 'assets/blastline/ui/upgrade-spread.webp', synergy: 'Covers more lanes; each extra round trades 12% damage' },
